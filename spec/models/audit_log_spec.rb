...
RSpec.describe AuditLog, type: :model do
  ...
  describe 'validations' do
    it 'requied to have an user asociation' do
    ...
    it 'should have a start date of 6 days prior' do  
      new_audit = AuditLog.create(user_id: 2)
      expect(new_audit.start_date).to eq(Date.today - 6.days)
    end
