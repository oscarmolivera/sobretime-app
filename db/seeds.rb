...
20.times do |post|
  Post.create!(date: Date.today, rationale:"#{post+1} It is a Comment Post from Oscar Olivera!", user_id: 1)
end
20.times do |post|
  Post.create!(date: Date.today, rationale:"#{post+1} It is a Comment Post From Normal User!", user_id: 2)
end
10.times do |post|
  Post.create!(date: Date.today, rationale:"#{post+1} It is a Comment Post from ADMIN User!", user_id: 3)
end
